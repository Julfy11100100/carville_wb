...
# Допустимые поля для анализа
VALID_ANALYZE_PATTERN = r"characteristics_\d+"
VALID_ANALYZE_FIELDS = ["vendorCode", "barcode"]  # поля по котором сопоставляем на стороне WB
